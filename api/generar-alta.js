...
module.exports = async (req, res) => {
  ...
  try {
    ...
    await resend.emails.send({
      ...
      html: '<div style="font-family:Arial,sans-serif;max-width:600px"><h2 style="color:#365F91">SyncMed One — Indicaciones de Alta Dr. Pablo Vidal</h2><table cellpadding="7" border="1" style="border-collapse:collapse;width:100%;font-size:13px"><tr><td><b>Paciente</b></td><td>' + (nombre||'-') + '</td></tr><tr><td><b>Fecha</b></td><td>' + (fecha||'-') + '</td></tr><tr><td><b>Edad</b></td><td>' + (edad||'-') + '</td></tr><tr><td><b>FN</b></td><td>' + (fechaNacimiento||'-') + '</td></tr><tr><td><b>Procedimiento</b></td><td>' + (procedimiento||'-') + '</td></tr><tr><td><b>Cita</b></td><td>' + (fechaCita||'-') + '</td></tr></table><p style="font-size:12px;color:#555">📎 Adjunto 1: Indicaciones de alta<br>📎 Adjunto 2: Receta</p>' + (indicacionesExtra ? '<p><b>Cambios medicamentos:</b> ' + indicacionesExtra + '</p>' : '') + (indicacionesEspeciales ? '<p><b>Indicaciones especiales:</b> ' + indicacionesEspeciales + '</p>' : '') + '</div>',
      attachments: [
